    ...
    return (
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-50">
            <div className="container px-4 md:px-6">
                <h2 className="text-3xl font-bold tracking-tighter text-center mb-8 sm:text-4xl md:text-5xl">How It Works</h2>
                    ...
                    {steps.map((step, index) => (
                        <div key={step.number} className="flex flex-1 items-center gap-4">
                            <div className="flex flex-col items-center">
                                ...
                                <div className="flex-1 h-full w-0.5 bg-primary mt-2 md:hidden"></div>
                            </div>
